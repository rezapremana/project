...
public class DestinationsAdapter extends RecyclerView.Adapter<DestinationsAdapter.ViewHolder> {
        ...
        mValues = new ArrayList<DestinationItem>() {
            {
                ...
                add(new DestinationItem("Bolias Beach", "Fair waves", "3-4 ft", "4", R.color.wavesFair, R.drawable.image_bolinas, null));
        ...
        mValues = new ArrayList<DestinationItem>() {
            {
                ...
                add(new DestinationItem("Bolinas Beach", "Fair waves", "3-4 ft", "4", R.color.wavesGood, R.drawable.image_bolinas, pics2));
                add(new DestinationItem("Cowell's Cove", "Poor waves", "1-2 ft", "1", R.color.wavesGood, R.drawable.image_cowells_cove, pics3));
            }
        };
    }
    ...
    public ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.fragment_destination, parent, false);
    ...
    public void onBindViewHolder(final ViewHolder holder, int position) {
        ...
        holder.mCondition.setTextColor(ContextCompat.getColor(holder.mCondition.getContext(), item.textColor));
